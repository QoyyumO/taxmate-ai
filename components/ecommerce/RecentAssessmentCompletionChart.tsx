...
export default function RecentAssessmentCompletionChart() {
  const series = [75.55];
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="shadow-default rounded-2xl bg-white px-5 pt-5 pb-11 sm:px-6 sm:pt-6 dark:bg-gray-900">
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-theme-sm mt-1 font-normal text-gray-500 dark:text-gray-400">
              An Analysis of your most recently published assessment
            </p>
          </div>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          Your most recent assessment is the senior product manager assessment
        </p>
      </div>
