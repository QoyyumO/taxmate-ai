...
interface Product {
  ...
  assessment: string; // assessment name
  score: string; // candidate score
  status: 'Success' | 'Pending' | 'Failure'; // Status of the candidate's assesment
}
...
const tableData: Product[] = [
  {
    id: 1,
    name: 'Femi Oluwayomi',
    assessment: 'Software Engineer II',
    score: '85%',
    status: 'Success',
  },
  {
  ...
  },
  {
    id: 4,
    name: 'Lanre Shittu',
    assessment: 'Executive Assistant',
    score: '65%',
    status: 'Success',
  },
];
...
export default function RecentCandidates() {
  return (
    <div className="h-full overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pt-4 pb-3 sm:px-6 dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <TableCell className="py-3">
                  <div className="flex items-center gap-3">
                    <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                      <span className="inline-block h-[50px] w-[50px] rounded-full bg-gray-800"></span>
                    </div>
                    <div>
