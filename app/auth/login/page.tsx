...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      try {
        await createUser(userData);
        console.log('User document created during Google login');
      } catch (error) {
        // User might already exist, that's okay
        console.log('User might already exist or creation failed:', error);
      }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-grey-100 dark:bg-[#2e312e] dark:text-white"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={isLoading}
                className="w-full inline-flex gap-2 justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-white text-sm font-medium text-black dark:text-black hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
